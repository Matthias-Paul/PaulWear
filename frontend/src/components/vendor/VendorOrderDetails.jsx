...
const VendorOrderDetails = () => {
  ...
  const markMutation = useMutation({
    mutationFn: async () => {
      const res = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/api/vendor/markAsDelivered/${id}`,
        {
          method: "PUT",
  ...
  return (
    <>
      <div className=" pt-12 md:pt-0 pr-[12px] mx-auto max-w-[1000px] mb-20 ">
        <h2 className="font-bold mb-2 text-xl md:text-2xl mt-6 ">
          {" "}
          Order Details{" "}
        </h2>
        {!orderDetails ? (
              ...
              <div className="flex flex-col items-start sm:items-end mt-4 sm:mt-0  ">
                ...
                <span>
                  <button
                    ...
                    className={`py-1 px-2 ${
                      markMutation.isPending || orderDetails?.isDelivered
