  ...
  return (
    <>
      <div className="relative w-full   mx-auto max-w-[1400px] " >
           <img className="pt-[84px] md:pt-[92px] w-full max-w-[1400px] max-h-[550px]  object-cover flex-shrink-0  " alt="Hero-image" src="https://res.cloudinary.com/drkxtuaeg/image/upload/v1743594490/three-multicultural-women-street_1_aczerz.jpg" />
