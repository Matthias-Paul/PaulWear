  ...
  return (
    <>
      <div className="relative w-full mx-auto max-w-[1400px] " >
           <img className="pt-[84px]  md:pt-[92px] w-full max-w-[1400px] max-h-[650px] min-h-[450px] object-cover flex-shrink-0  " alt="Hero-image" src="https://res.cloudinary.com/drkxtuaeg/image/upload/v1743594490/three-multicultural-women-street_1_aczerz.jpg" />
           <div className="absolute pt-[92px] font-bold px-[12px] inset-0 flex flex-col text-white justify-center items-center text-center " >
              <h1 className=" text-2xl  max-w-[800px] md:text-4xl leading-[40px] sm:leading-[60px] tracking-tighting uppercase  "> Connecting You to the Best Vendors  on Campus and Beyond </h1>
