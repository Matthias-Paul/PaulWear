...
import CancelledOrderPage from "./components/admin/CancelledOrderPage.jsx";
import VendorAccountPage from "./components/admin/VendorAccountPage.jsx";
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/" element={<UserLayout />}>
            ...
            <Route
              path="verifyToken/reset-password"
              element={<VerifyTokenAndResetPassword />}
            />
