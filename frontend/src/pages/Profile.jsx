      ...
      <div className="mx-auto max-w-[1400px]   min-h-full pb-40  flex flex-col " >
            <div className=" flex-grow   " >
                <div className="flex  flex-col md:gap-x-6 md:flex-row gap-y-6 md:gap-y-6  ">
                    {/* Left section */}
                    <div className="md:w-1/3 lg:w-1/4 mb-[-95px] lg:mb-0 mx-[12px] md:mx-0 pt-[115px] shadow-md md p-6 rounded-lg " >
                            <h1 className=" text-2xl md:text-3xl truncate font-semibold mb-3 " > Nicholas James </h1>
                            <p className="text-gray-600 text-lg mb-4 truncate " > James@gmail.com </p>
