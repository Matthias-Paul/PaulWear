...
import { getOrders, getOrderDetails, getVendorOrders, getAllOrders, editVendorOrders, updateOrderIsReceived } from "../controllers/order.js"
...
router.put("/orders/buyer/:id",  verifyUser, updateOrderIsReceived)
